      ...
      >
        ...
        >
          ...
          <ul>
            <li>
              <Link
                className="font-medium text-sm text-emerald-700 hover:text-emerald-800 dark:hover:text-emerald-300 flex items-center py-1 px-3"
                to="#0"
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <svg className="w-3 h-3 fill-current text-emerald-700 shrink-0 mr-2" viewBox="0 0 12 12">
